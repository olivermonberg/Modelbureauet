...
{
    public class ModelWebContext : IdentityDbContext<ModelWebUser>
    {
        public ModelWebContext(DbContextOptions<ModelWebContext> options)
            : base(options)
        {
        }
        ...
        public DbSet<ModelWeb.Models.Model> Model { get; set; }
